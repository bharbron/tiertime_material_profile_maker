...
python tiertime_material_profile_maker.py --copy-from ABS --name CUSTOM --manufacturer CUSTOM --scan-speed 21 42 42 --aspeed 1000 1000 1000 --withdraw-length 6 custom.fmd
